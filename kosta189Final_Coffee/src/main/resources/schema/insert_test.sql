...
'testname5', '01000000000', 'aaa@aaa.com', 'imgtest.jpg',3000000,sysdate,1,1);
...
insert into tb_data(dataItemNo, dataItemName, dataItemCategory, dataItemPrice) 
    values(seq_data.nextval, '도시락 용기', '생활용품', 10000);
insert into tb_data(dataItemNo, dataItemName, dataItemCategory, dataItemPrice) 
    values(seq_data.nextval, '겨울돕바', '옷', 150000);
insert into tb_data(dataItemNo, dataItemName, dataItemCategory, dataItemPrice) 
    values(seq_data.nextval, '이불', '생활용품', 50000);
insert into tb_data(dataItemNo, dataItemName, dataItemCategory, dataItemPrice) 
    values(seq_data.nextval, '텐트', '생활용품', 90000);
insert into tb_data(dataItemNo, dataItemName, dataItemCategory, dataItemPrice) 
    values(seq_data.nextval, '도시락', '먹을거', 10000);
