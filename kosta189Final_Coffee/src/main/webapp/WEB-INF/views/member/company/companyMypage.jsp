			...
			<div class="mypage-sidebar">
				...
				<ul>
					...
					<li class="sidebar-2"><a
						href="${pageContext.request.contextPath}/company/companyProject">내
							프로젝트</a></li>
				</ul>
			</div>
				...
				<div class="mypage-1-content">
					<div class="inform-container">
						<div class="inform-items">
							...
							<div class="inform-input">${member.id}<input type="hidden"
						...
						<div class="inform-items">
							...
							<div class="inform-input">${member.company.companyAddr}<input
									type="hidden" name="companyAddr"
									value="${member.company.companyAddr}">
							</div>
						</div>
						...
						<div class="inform-items">
							...
							<div class="inform-input">
								<input type="text" id="phone" name="companyCall"
