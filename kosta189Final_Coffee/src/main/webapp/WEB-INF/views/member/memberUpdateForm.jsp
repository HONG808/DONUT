            ...
            <div class="mypage-1-content">
                <div class="inform-container">
                    ...
                    <div class="inform-items">
                        ...
                        <div class="inform-input"><input type="text" name="email" value="${member.email}">
                        </div>
                    </div>
                    <div class="inform-items">
                        <div class="inform-label"><span>사진</span></div>
                        <div class="inform-input"><div>${member.picture}</div></div>
                    </div>
                    
                    <!-- 저장 버튼 -->
                    <div class="inform-save" style="margin-top:20px;display:flex;justify-content: center;">
                        <input type="submit" class="btn_2" value="저장" style="width:100px;">
                        <input type="button" class="btn_2" value="탈퇴" style="width:100px;">
                    </div>
                    <!-------------->
                </div>
