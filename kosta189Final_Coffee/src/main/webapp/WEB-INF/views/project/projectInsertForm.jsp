        ...
        <div class="register-items">
                    ...
                    <div class="register-goal">
                        ...
                        <div id="goods_goal_input" class="input hidden">
                            <input type="text" id="itemGoal" name="" placeholder="목록에서 수량 입력 후 확정 버튼을 눌러주세요" readonly="readonly"></span>
						</div> 
                    </div>
...
$(function(){
    ...
    $("#rewardBtn").on("click",function(){
		var str ='';
    	str += '<input type="text" name="rewardItem" placeholder="리워드 제품명" style="width:200px;margin:0 0 10px 10px;">';
    	str += '<input type="text" name="condition" placeholder="조건금액" style="width:200px;margin:10px 0 0 10px;">';
